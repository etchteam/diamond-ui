...
export const StretchOneSide = () => `
  ...
  <dmd-spacing bottom="sm"></dmd-spacing>
  <dmd-grid>
    <dmd-grid-item>
      <docs-cell>Fixed</docs-cell>
    </dmd-grid-item>
...
export const ResponsiveColumns = () => `
  <dmd-grid wrap="wrap">
    <dmd-grid-item mobile="12" tablet="6" desktop="3">
...
export const MobileCTA = () => `
  <dmd-wrap gutter="none" size="md">
    <dmd-grid wrap="wrap" direction="row-reverse">
      <dmd-grid-item mobile="12" tablet="3">
        <dmd-button variant="primary" width="full-width">
