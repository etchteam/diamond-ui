  ...
  render: ({ padding, theme }) => html`
    <dmd-section padding="${padding}" class="dmd-theme-${theme}">
      <dmd-wrap size="lg">
        ...
        <dmd-grid>
          <dmd-grid-item mobile="6" tablet="auto">
            <dmd-button variant="primary" width="full-width-mobile">
              <button type="button">Button text</button>
            </dmd-button>
          </dmd-grid-item>
          <dmd-grid-item mobile="6" tablet="auto">
            <dmd-button width="full-width-mobile">
              <button type="button">Button text</button>
            </dmd-button>
          </dmd-grid-item>
        </dmd-grid>
  ...
  render() {
    return html`
      ${['light', 'medium', 'dark'].map(
        (theme) => html`
          <dmd-section padding="fluid" class="dmd-theme-${theme}">
            <dmd-wrap size="lg">
              <h3>Section title</h3>
              <p class="dmd-spacing-bottom-lg">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
