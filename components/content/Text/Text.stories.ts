...
export default {
  ...
  argTypes: {
    ...
    lineLimit: {
      ...
      options: ['1', '2', '3', '4'],
      description:
        "Limits the text to the specified number of lines and adds an ellipsis if it's too long. 'dmd--line-limit-1' is an alias for 'dmd'dmd-ncate'.",
    },
    decoration: {
      control: {
        type: 'inline-radio',
