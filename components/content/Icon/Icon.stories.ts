...
export const Icon: StoryObj = {
  render: (args) => html`
    <dmd-icon variant="${args.variant}" label="${args.label}">
  ...
  render: () => html`
    ...
    >
      ...
      <dmd--item grow shrink>
        <h3 class="dmd-spacing-bottom-none">Title text</h3>
      </dmd-grid-item>
    </dmd-grid>
    <dmd- align-items="baseline" gap="xs">
      <dmd--item>
        <dmd->
          <svg fill="none" viewBox="0 0 24 24" height="24" width="24">
            <path
