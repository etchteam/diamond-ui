...
export class DocsSpacing extends LitElement {
  ...
  static readonly styles = css`
    ...
    .docs-spacing__border {
      border-bottom: 1px solid var(--dmd-r-red-100);
      border-top: 1px solid var(--dmd-r-red-100);
      height: 100%;
      position: relative;
      width: 7px;
    }
    ...
    .docs-spacing__border::before {
      background-color: var(--dmd-r-red-100);
      content: '';
      display: block;
      height: 100%;
      left: 50%;
  ...
  render() {
    ...
    return html`
      <style>
        :host {
          --docs-spacing-height: var(--dmd-ing-${size});
        }
      </style>
